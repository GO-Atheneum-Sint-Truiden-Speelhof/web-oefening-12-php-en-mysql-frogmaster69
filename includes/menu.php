...
<nav class="navbar navbar-expand-lg navbar-dark">
			...
			<div class="collapse navbar-collapse" id="menubalk">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						<a href="begin.php?page=wed" class="nav-link">Wedstrijd</a>
					</li>
					<li class="nav-item">
						<a href="begin.php?page=win" class="nav-link">Prijzen</a>
					</li>
					<li class="nav-item">
						<a href="begin.php?page=laur" class="nav-link">Laureaat vorig jaar</a>
					</li>
					<li class="nav-item">
						<a href="begin.php?page=deel" class="nav-link">Deelnemen</a>
					</li>
					<li class="nav-item">
						<a href="begin.php?page=login2" class="nav-link">login</a>
					</li>
				</ul>
			</div>
